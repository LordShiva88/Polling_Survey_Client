  ...
  return (
    <div>
      ...
      {pendingSurveys.length === 0 ? (
        <Nodata path={'/'} emptyMessage={'There are no pending Survey!'}></Nodata>
      ) : (
              ...
              <tbody>
                {pendingSurveys.map((survey, index) => (
                  ...
                  >
                    ...
                    <td className="flex items-center gap-2 mt-5">
                      <button
                        onClick={() =>
                          handleSurveyAction(survey._id, "Approved")
                        }
                    ...
                    <td className="px-4 py-2 font-semibold text-green-500">{survey.status}</td>
                  </tr>
                ))}
              </tbody>
            </table>
