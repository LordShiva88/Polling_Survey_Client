...
const ContactUs = () => {
  ...
  subTitle="Have questions or feedback? Reach out to us. We value your input and are here to assist you."
  pageName="Contact Us"
></PageBanner>
      ...
      ></Heading>
          <div className="flex items-stretch justify-center">
            <div className="grid md:grid-cols-2">
              ...
              <div
                className="card h-fit max-w-6xl p-5 md:p-12 bg-opacity-60 backdrop-blur-md"
                id="form"
              >
