    ...
    >
      <div className="container mx-auto flex justify-between">
        ...
        <div className="flex items-center gap-5">
          <button className="btn flex items-center space-x-2 btn-outline btn-info">
            <FaCrown /> PRO
          </button>
          <div className="dropdown dropdown-end">
            ...
            {isDropdownOpen && (
              <div className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-black rounded-box w-52 text-white">
